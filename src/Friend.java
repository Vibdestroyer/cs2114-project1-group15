...
public class Friend extends Person {
    ...
    public Friend() {
        ...
        Choice talk = new Choice("Talk to your friend " + name,
            "You stop and talk to your friend " + name
                + " for 5 minutes and do not travel at all.", 5, 0, 1);

        this.choices.set(0, talk);

        // snack option if friend has food
        if (this.haveFood) {
            Choice food = new Choice("Take a snack from your friend " + name,
        ...
        if (this.haveCar) {
            Choice car = new Choice("Get a ride to class from your friend "
                + name,
