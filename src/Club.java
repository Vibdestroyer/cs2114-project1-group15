...
public class Club extends Person {
    ...
    public Club() {
        ...
        if (this.hasEnergyDrinks) {
            ...
            talk = new Choice("Talk to club members at a booth",
                "You stop and talk to " + this.numberOfPeople
                    + " club members for " + this.numberOfPeople
            ...
            talk = new Choice("Talk to club members at a booth",
                "You stop and talk to " + this.numberOfPeople
                    + " club members for " + this.numberOfPeople
                    + " minutes and do not travel anywhere.",
                this.numberOfPeople, 0, 1);
        }
